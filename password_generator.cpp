...
//getKey() is another utility function that is used to rnadomly generate
...
void generate_password(int length){
    ...
    while(count<length){
        ...
        //4 is for string s_symbol

        int k = selectArray();

        //for the first character of the passsword it is mentioned that,
        ...
        switch(k){
            case 1:
                ...
                if((count_alphabet==2)&&(count_number==0 || count_alphabet==0 || count_ALPHABET==0 || count_ALPHABET==1 || count_s_symbol==0)){
                    break;
                }
                key = getKey();
            ...
            case 2:
                ...
                //ALPHABET characte has been fulfilled or not
                //in case it has been fulfilled and the minimum requirements of
                //other characters are still left it will break
...
int main(){
    ...
    do{
        ...
        cout << "Press key 1 to Generate Password and key to exit: ";
        cin >> opt;
        ...
        switch(opt){
            case 1:
                ...
                //Lengthshould not exceed 100, the program should show an error if it exceeds
                else if(length > 100){
            ...
            default:
                ...
                if(opt!=2){
                    cout << "\nInvalid choice\n";
                    cout << "Please Press (1) to generate password and Press (2) to exit.\n";
                    cout << "Press any key to try again \n";
                    getchar();
                }
                break;
